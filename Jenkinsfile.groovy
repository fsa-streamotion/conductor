        ...
        stage('PR Build + PREVIEW') {
            ...
            steps {
                container('maven') {
                    ...
                    sh "export VERSION=$PREVIEW_VERSION && skaffold build -f skaffold-server.yaml && export VERSION=$PREVIEW_VERSION && skaffold build -f skaffold-ui.yaml && skaffold build -f skaffold-all.yaml"
